...
//реализовать проброс заголовков через хедер подумать если их несколько заголовков***
...
//напомнить на неделе о сервисе нотификации
//обработка ошмбок везде аккуратную сдлетать по формата уак обсуждали